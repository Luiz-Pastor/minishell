...
void						*add_infile(t_file_type type, char *name,
								t_cmd *cmd);
void						*add_outfile(t_file_type type, char *name,
								t_cmd *cmd);
char						**add_command(int start, int end, t_msh *msh,
								char **res);
void						*check_command(int *index, t_cmd *cmd, t_msh *msh);
void						*check_argument(int *index, t_cmd *cmd, t_msh *msh);
void						*check_infile(int start, int *index, t_cmd *cmd,
								t_msh *msh);
void						*check_outfile(int start, int *index, t_cmd *cmd,
								t_msh *msh);
...
char						**replace_content(t_msh *msh, char *variable,
								char *content);
...
void						mid_child(t_msh *msh, int *fd, int *new,
								t_cmd *cmds);
